...
| CAP-004 | Opportunity pipeline | Track sales opportunities, allowed stage transitions, terminal outcomes, and closure rules. | Sales, Sales Manager | ACC-007, ACC-008, ACC-013 | SVC-CAND-OPPORTUNITY | Must enforce forbidden transitions, Won/Lost terminal behavior, lost reason, and Won-at-contract-signing (DEC-017). |
...
| CAP-011 | Persistence and production operation | Ensure committed CRM data persists and the CRM can be deployed and operated with real configuration. | Administrator / Operator | ACC-016, ACC-017 | SVC-CAND-PLATFORM-OPS | Must resolve OQ-001 and define production environment, backup, restore, and ownership. |
...
| FLOW-CAP-004 | Contract signing closes opportunity; payment tracked post-sale | CAP-004, CAP-005, CAP-008 | ACC-011, ACC-013, ACC-014 | Architecture to assign | Won occurs at contract signing (DEC-017); payment is post-sale and decoupled (DEC-019); overpayment is blocked. |
