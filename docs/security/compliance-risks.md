...
| COMP-013 | P0/P1 | Retention expectations are not represented in data design. | Contract/payment/log retention may be shortened accidentally. | Architecture and MDA must carry the v1 retention policy into data design and lifecycle states. | Architecture, Domain Modeling, Audit | G5, G6, Audit | Input to Architecture |
