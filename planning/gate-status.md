...
| G11 | Integration -> Audit **[RETURN: Codex -> Claude]** | Integration Owner | Codex -> Claude | **Gate Blocked** | Set back by G12 audit 2026-06-03 | 2026-06-03 | G12 rework partially remediated BLK-G12-001/004/002/005. Further rework is blocked at BLK-G12-003/007 because the current Volcengine operator account lacks `vpc:CreateSecurityGroup`; see `planning/blockers.md` and `docs/release/evidence/volcengine-security-group-rework-blocked-2026-06-03.md`. |
| G12 | Audit -> Release/Rework | Audit | Claude | **Gate Blocked (REWORK blocked)** | Audit (independent), 5 parallel author≠auditor passes | 2026-06-03 | G12 performed: 2 dimensions FAILED (service-boundary/security; release evidence). Codex rework stopped at BLK-G12-003/007 due missing Volcengine VPC IAM permission; no release. Decision: `archive/reviews/g12-audit/g12-audit-decision-2026-06-03.md`. |
