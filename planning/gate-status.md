...
| G11 | Integration -> Audit **[RETURN: Codex -> Claude]** | Integration Owner | Codex -> Claude | **Gate Blocked** | Held for Claude final G12 focused re-audit after Codex rework #2 completion | 2026-06-03 | Codex completed BLK-G12-001/006/009/010 rework #2 with commits and evidence. Gate remains blocked until Claude performs final focused G12 re-audit. |
| G12 | Audit -> Release/Rework | Audit | Claude | **Gate Blocked (awaiting final focused re-audit)** | Audit (independent): 1st audit + re-audit completed; Codex rework #2 returned for final review | 2026-06-03 | Rework #2 completed by Codex: BLK-G12-001/006/009/010 are marked Resolved in `planning/blockers.md` with evidence. Do not release until Claude final focused G12 re-audit passes. |
